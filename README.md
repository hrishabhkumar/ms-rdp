...
![https://github.com/hrishabhkumar/ms-rdp/actions](https://github.com/hrishabhkumar/ms-rdp/workflows/CI/badge.svg)
...
`NPM` will choose which native package should download from `registry` automatically. You can see [npm](./npm) dir for details. And you can also run `yarn add ms-rdp` to see how it works.
